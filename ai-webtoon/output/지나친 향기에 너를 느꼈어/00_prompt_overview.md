# 지나친 향기에 너를 느꼈어 패널 설명

## 전체 MV 방향

곡: `지나친 향기에 너를 느꼈어` | 장르: `Alternative R&B, PBR&B, 75BPM, Moody, Atmospheric, Heavy Sub-Bass, Minimalist Production, Breathy Intimate Male Vocals, Ethereal, Dark Pop, High Fidelity` | 감정: `미지정`
BPM: 75 BPM | 분위기: 미지정

...
- Profile: `progressive_ensemble` — 점층적 앙상블 무대
- Stage layout: clean open stage that begins with one focal performer and gains visible layers of instruments and movement
- Wardrobe range: retain original member identity while varying simple geometric layers and one contrasting accent per section
...
- Talking Heads — https://a24films.com/films/stop-making-sense

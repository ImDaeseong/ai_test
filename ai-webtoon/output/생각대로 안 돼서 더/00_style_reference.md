# 생각대로 안 돼서 더 — 웹툰 스타일 고정 블록

> 모든 패널 프롬프트 생성 시 이 블록을 맨 앞에 붙인다.
> 스타일: **cute_pop** — 밝고 통통 튀는 팝 cartoon 스타일. 밝은 색감, 반짝이는 포인트 이펙트, 친근한 캐릭터.
...
```
bubbly cute cartoon pop style, thick rounded black outlines, bright vivid flat colors, round chubby skeleton characters with sparkling star and heart effects around glowing hollow eye sockets, clean cheerful comic panel, bright background with simple colorful shapes, playful original cartoon skeleton band
```
...
## 곡 스타일 (Cute Pop Cartoon)

- 스타일: cute_pop — 밝고 통통 튀는 팝 cartoon 스타일. 밝은 색감, 반짝이는 포인트 이펙트, 친근한 캐릭터.
- 분위기: 미지정 / 감정: 미지정
- BPM 구간: medium (100 BPM)
- 선 굵기: thick clean rounded outlines
- 색상: bright flat colors, neon magenta pop accents, sparkle star effects
- 표정 연출: bright sparkling eye sockets, heart effects, big open cartoon smile-equivalent poses
- Nijijourney: `--niji 7 --ar 16:9 --s 200`

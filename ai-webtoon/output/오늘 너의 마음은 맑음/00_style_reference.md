...
- Profile: `raw_power_stage` — 거친 소규모 록 스테이지
- Stage layout: compact rectangular stage with practical amplifier stacks, drummer close behind, and members sharing a tight performance zone
- Wardrobe range: retain the original skeleton-band outfits but simplify them into worn matte layers with one song-specific accent color

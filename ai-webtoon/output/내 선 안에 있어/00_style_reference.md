# 내 선 안에 있어 — 웹툰 스타일 고정 블록

> 모든 패널 프롬프트 생성 시 이 블록을 맨 앞에 붙인다.
> 스타일: **cute_emotional** — 감성적이고 따뜻한 귀여운 cartoon 스타일. 부드러운 색감, 눈물 한 방울, 여백으로 감정 표현. 발라드에 적합.
...
## 곡 스타일 (Cute Emotional Cartoon)

- 스타일: cute_emotional — 감성적이고 따뜻한 귀여운 cartoon 스타일. 부드러운 색감, 눈물 한 방울, 여백으로 감정 표현. 발라드에 적합.
- 분위기: 미지정 / 감정: 미지정
- BPM 구간: medium (105 BPM)
- 선 굵기: medium-thick rounded outlines, slightly softer than default
- 색상: warm flat tones with gentle neon magenta glow, no harsh contrasts
- 표정 연출: subtle teardrop sparkle, soft eye socket glow intensity, gentle drooping skull angle
- Nijijourney: `--niji 7 --ar 16:9 --s 150`

## Performance Direction

- Profile: `intimate_four_piece` — 친밀한 4인조 라이브
- Stage layout: small balanced four-piece stage with warm practical lamps, visible instruments, and close relational spacing
- Wardrobe range: retain the original outfits with soft fabric overlays and restrained song-specific accent colors
...
- Nirvana — https://www.nirvana.com/releases/live-at-reading/
- The Cure — https://www.thecure.com/news/2019/40-live-cur%C3%A6tion-25-anniversary/

...
- Profile: `atmospheric_longform` — 대기감 중심 포스트펑크 무대
- Stage layout: deep layered stage with wide spacing, backlit instruments, and empty negative space around the vocalist
- Wardrobe range: retain original costumes using low-contrast cool accents and soft fabric shapes without copying real styling

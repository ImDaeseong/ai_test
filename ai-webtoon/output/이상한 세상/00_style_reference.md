...
> 스타일: **cute_dramatic** — 드라마틱하지만 귀여운 cartoon 스타일. 흑백 베이스 + 네온 포인트, 통통한 캐릭터로 무게감 있게 표현.
...
## 곡 스타일 (Cute Dramatic Cartoon)

- 스타일: cute_dramatic — 드라마틱하지만 귀여운 cartoon 스타일. 흑백 베이스 + 네온 포인트, 통통한 캐릭터로 무게감 있게 표현.
- 분위기: 미지정 / 감정: 미지정
- BPM 구간: medium (110 BPM)
- 선 굵기: thick bold outlines, dramatic weight variation for emphasis
- 색상: monochrome dark flat base with single neon magenta highlight spot
- 표정 연출: intense glowing hollow eye sockets, single dramatic teardrop, serious brow-equivalent skull tilt
- Nijijourney: `--niji 7 --ar 16:9 --s 300 --style raw`

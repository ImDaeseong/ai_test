# 그래서 더 좋아 — 웹툰 스타일 고정 블록

> 모든 패널 프롬프트 생성 시 이 블록을 맨 앞에 붙인다.
> 스타일: **telephone-signal-pop** — Telephone-signal-pop custom cartoon style with warm phone-signal pulse, ajaeng lead shimmer, spacious calm, and a gentle uplifting hook.
...
## 곡 스타일 (Telephone Signal Pop Cartoon)

- 스타일: telephone-signal-pop — Telephone-signal-pop custom cartoon style with warm phone-signal pulse, ajaeng lead shimmer, spacious calm, and a gentle uplifting hook.
- 분위기: 미지정 / 감정: 미지정
- BPM 구간: medium ()
- 선 굵기: medium-thick rounded outlines with soft pulse accents
- 색상: warm flat colors, amber signal glow, gentle neon magenta highlights, no harsh contrast
- 표정 연출: soft glowing hollow eye sockets, tiny signal-wave sparkle marks, gentle hopeful skull tilt
- Nijijourney: `--niji 7 --ar 16:9 --s 180`

## Performance Direction

- Profile: `geometric_electronic` — 기하학적 전자음악 무대
- Stage layout: elevated central geometric console with symmetrical band positions and a large abstract light surface behind it
- Wardrobe range: retain original skeleton identity with abstract reflective panels and no helmet, logo, or recognizable artist costume
...
- Daft Punk — https://daftpunk.com/pages/alive-2007

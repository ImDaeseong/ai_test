...
- Profile: `audience_light_spectacle` — 관객 조명형 스타디움
- Stage layout: wide stadium platform with a central band zone and visual pathways extending into a field of audience lights
- Wardrobe range: retain original outfits with bright removable color panels that change with the lighting palette
...
- Coldplay — https://www.coldplay.com/emissions-update/

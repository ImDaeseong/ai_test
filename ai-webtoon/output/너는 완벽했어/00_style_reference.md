# 너는 완벽했어 — 웹툰 스타일 고정 블록

> 모든 패널 프롬프트 생성 시 이 블록을 맨 앞에 붙인다.
> 스타일: **cute_manhwa** — 귀엽고 발랄한 cartoon 웹툰 스타일. 두꺼운 외곽선, 플랫 밝은 색, 통통한 캐릭터 비율. 기본 스타일.
...
## 곡 스타일 (Cute Cartoon Manhwa)

- 스타일: cute_manhwa — 귀엽고 발랄한 cartoon 웹툰 스타일. 두꺼운 외곽선, 플랫 밝은 색, 통통한 캐릭터 비율. 기본 스타일.
- 분위기: 미지정 / 감정: 미지정
- BPM 구간: very_fast (174 BPM)
- 선 굵기: thick bold black outlines, consistent line weight
- 색상: flat bright cel colors, no gradients on characters, neon magenta accents
- 표정 연출: exaggerated simple cartoon expressions, round glowing hollow eye sockets, manga sparkle effects
- Nijijourney: `--niji 7 --ar 16:9 --s 250`
